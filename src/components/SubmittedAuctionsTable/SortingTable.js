...
const SubmittedAuctionTable = (props) => {
                ...
                <s.tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    return (
                      ...
                      >
                        {cell.column.Header === "Submitted at"
                  ...
                  <s.td>
                    <s.actionCon>
                      {row.original.is_published === 1 ? (
                        <Tooltip
                          title="Unpublish this auction"
                          aria-label="all bids"
                        >
                          <IconButton onClick={props.handleUnPub({ row })}>
                        ...
                        <Tooltip
                          ...
                          aria-label="all bids"
                        >
                          <IconButton onClick={props.handlePub({ row })}>
                      ...
                      <Link
                        href={{
                          ...
                          query: {
                            id: row.original.id, // pass the id
                          },
                        }}
                      >
...
export default SubmittedAuctionTable;
