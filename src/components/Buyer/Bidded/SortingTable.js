                ...
                <s.tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    return (
                      ...
                      >
                        {cell.column.Header === "Created at" || cell.column.Header === "Closed at"
                          ? cell.value === null ? "----" : moment(cell.value).format("lll")
                          : cell.column.Header === "Winner" ? cell.value === 0 ? "Not Winner":"Winner" :  cell.render("Cell")}
                      </s.td>
                    );
                  })}
                  ...
                  <s.td>
                    <s.actionCon>
                      <Tooltip title="View All Bids" aria-label="all bids">
                        <IconButton onClick={props.handleModal({ row })}>
                          <ListAltIcon style={{ color: "#599f22" }} />
                        </IconButton>
                      </Tooltip>
                      ...
                      <Link
                        href={{
                          ...
                          query: {
                            id: row.original.auction_id, // pass the id
                          },
                        }}
                      >
...
export default LiveSortingTable;
