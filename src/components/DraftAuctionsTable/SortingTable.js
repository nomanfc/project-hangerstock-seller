                ...
                <s.tr {...row.getRowProps()} key={index}>
                  ...
                  <s.td>
                    <s.actionCon>
                      ...
                      >
                        <Tooltip title="Edit draft" aria-label="edit">
                          <IconButton>
                            <EditIcon style={{ color: "#599f22" }} />
                          </IconButton>
                        </Tooltip>
                      </Link>

                      <Tooltip title="Remove this draft" aria-label="remove">
...
export default DraftAuctionTable;
