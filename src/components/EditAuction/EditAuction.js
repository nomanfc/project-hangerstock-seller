...
import {
  ...
  get_draft_details_by_aid,
  update_post_details,
  update_shipping_details,
  update_post_details_mobile,
  update_postmanifest,
  remove_postmanifest,
  update_bid_details,
...
const Edit = () => {
  ...
  const [reload, setReload] = useState(1000000);
  ...
  const [productDetails, setProductDetails] = useState({
    ...
    auction_id: parseInt(router?.query?.id),
  });
  ...
  useEffect(() => {
    get_draft_details_by_aid(parseInt(router?.query?.id)).then((res) => {
      if (res && res.data) {
        setEditData(res?.data?.data);
        setCategoryName(res?.data?.data?.product_details?.category);
        setShippingDetails(res?.data?.data?.shipping_details);
        setProductDetails(res?.data?.data?.product_details);
        setProductDetailsMobile(res?.data?.data?.mobile_details);
        setBidDetails(res?.data?.data?.bid_details);
        if (res.data.data?.manifest_details[0]) {
          setCountManifest(res?.data?.data?.manifest_details);
        }
      }
    });
  }, [reload]);
  ...
  const handleAddManifest = () => {
    if (countManifest[countManifest.length - 1].quantity) {
      create_postmanifest(countManifest[countManifest.length - 1]).then(
        (found) => {
          console.log(found);
  ...
  const handleRemoveManifest = (i) => {
    ...
    if (countManifest[countManifest.length - 1].quantity) {
      remove_postmanifest(countManifest[countManifest.length - 1]).then(
        (res) => {
  ...
  const handleShippinginfo = () => {
    if (editData && editData?.product_details?.id) {
      update_post_details(productDetails).then((res) => {
        setAuctionId({
          ...auctionId,
          auction_id: parseInt(editData?.product_details?.id),
        });
    ...
    if (!editData?.product_details?.id) {
  ...
  const handleManifest = () => {
    editData?.mobile_details
      ? update_post_details_mobile(productDetailsMobile)
      : create_postdetails_mobile(productDetailsMobile);

    if (editData && editData?.shipping_details?.id) {
      if (
        ...
        update_shipping_details(shippingDetails).then((res) => {
          if (res.data.success === 1) {
            setproductinfo(false);
            setshippinginfo(false);
            setmanifest(true);
    ...
    if (!editData?.shipping_details?.id) {
      if (
        shippingDetails.ship_from &&
        shippingDetails.ship_to &&
        shippingDetails.freight_type_id &&
  ...
  const handleBidinfo = () => {
    for (var i = 0; i < countManifest.length; i++) {
      update_postmanifest(countManifest[i]).then((found) => {
        // console.log(found);
      });
    }
  ...
  const handleMediafiles = () => {
    if (editData?.bid_details) {
      if (bidDetails.opening_bid_amount && bidDetails.duration_days) {
        update_bid_details(bidDetails).then((res) => {
          if (res.data.success === 1) {
            setproductinfo(false);
            setshippinginfo(false);
            setmanifest(false);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <FormControl required fullWidth size="small" style={{}}>
                    ...
                    >
                      ...
                      <SelectM
                        ...
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={parseInt(productDetails?.category_id)}
                        label="Category"
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      value={productDetailsMobile?.memory}
                      InputLabelProps={{
                        shrink: true,
                      }}
                    />
                    {/* <TextField
                      ...
                      value={productDetails?.cosmetic_condition}
                      onChange={handle_Product_Info}
                      variant="outlined"
                      InputLabelProps={{
                        shrink: true,
                    ...
                    {/* <TextField
                      ...
                      onChange={handle_Product_Info}
                      value={productDetails?.original_retail_price}
                      variant="outlined"
                      InputLabelProps={{
                        shrink: true,
                      }}
                    ...
                    <TextField
                      ...
                      name="manufacturer"
                      onChange={handle_Product_Info_Mobile}
                      value={productDetailsMobile?.manufacturer}
                      variant="outlined"
                      InputLabelProps={{
                        shrink: true,
                      }}
                  ...
                  >
                    ...
                    >
                      ...
                      <SelectM
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={parseInt(productDetails?.inventory_type_id)}
                    ...
                    >
                      ...
                      <SelectM
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={parseInt(productDetails?.condition_id)}
                    ...
                    <TextField
                      ...
                      name="model"
                      onChange={handle_Product_Info_Mobile}
                      value={productDetailsMobile?.model}
                      variant="outlined"
                      InputLabelProps={{
                        shrink: true,
                      }}
                    ...
                    <TextField
                      ...
                      name="carrier"
                      onChange={handle_Product_Info_Mobile}
                      value={productDetailsMobile?.carrier}
                      variant="outlined"
                      InputLabelProps={{
                        shrink: true,
                      }}
                ...
                >
                  <TextField
                    ...
                    onChange={handle_Product_Info_Mobile}
                    value={productDetailsMobile?.cell_phone_grade}
                    variant="outlined"
                    InputLabelProps={{
                      shrink: true,
                    }}
                  ...
                  <TextField
                    ...
                    onChange={handle_Product_Info}
                    variant="outlined"
                    value={productDetails?.packaging_details}
                    InputLabelProps={{
                      shrink: true,
                    }}
                  />
              ...
              >
                ...
                >
                  ...
                  >
                    <TextField
                      ...
                      id="outlined-basic"
                      label="Shiping From"
                      value={shippingDetails?.ship_from}
                      name="ship_from"
                    ...
                    >
                      ...
                      <SelectM
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={String(shippingDetails?.shipping_type)}
                        label="Shipping Type"
                        name="shipping_type"
                  ...
                  >
                    ...
                    >
                      ...
                      <SelectM
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={parseInt(shippingDetails?.freight_type_id)}
                        label="Freight Type"
                ...
                >
                  <TextField
                    ...
                    onChange={handle_Shipping_Info}
                    variant="outlined"
                    value={shippingDetails?.shipping_cost}
                    InputLabelProps={{
                      shrink: true,
                    }}
                  />
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        value={element?.product_condition}
                        onChange={(e) => handleManifestChange(index, e)}
                        variant="outlined"
                      />
                ...
                >
                  ...
                  >
                    <TextField
                      ...
                      value={bidDetails?.opening_bid_amount}
                  ...
                  >
                    <FormControl fullWidth size="small">
                      ...
                      <SelectM
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={parseInt(bidDetails?.duration_days)}
                        label="Duration (days)"
                        onChange={handle_Bid_Info}
                        name="duration_days"
                      >
